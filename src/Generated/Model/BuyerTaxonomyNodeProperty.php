 ...
 */
final readonly class BuyerTaxonomyNodeProperty
{
    /**
     ...
     * @param list<BuyerTaxonomyPropertyScale>|null $scales A list of available scales.
     ...
     * @param list<BuyerTaxonomyPropertyValue>|null $possible_values A list of supported property value strings for this property.
     * @param list<BuyerTaxonomyPropertyValue>|null $selected_values A list of property value strings automatically and always selected for the given property.
     */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            scales: isset($data['scales']) && is_array($data['scales'])
                ? array_values(array_map(static fn (array $i): BuyerTaxonomyPropertyScale => BuyerTaxonomyPropertyScale::fromArray($i), $data['scales']))
                : null,
            ...
            possible_values: isset($data['possible_values']) && is_array($data['possible_values'])
                ? array_values(array_map(static fn (array $i): BuyerTaxonomyPropertyValue => BuyerTaxonomyPropertyValue::fromArray($i), $data['possible_values']))
                : null,
            selected_values: isset($data['selected_values']) && is_array($data['selected_values'])
                ? array_values(array_map(static fn (array $i): BuyerTaxonomyPropertyValue => BuyerTaxonomyPropertyValue::fromArray($i), $data['selected_values']))
                : null,
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->scales !== null) {
            $data['scales'] = array_map(static fn (BuyerTaxonomyPropertyScale $i): array => $i->toArray(), $this->scales);
        }
        ...
        if ($this->possible_values !== null) {
            $data['possible_values'] = array_map(static fn (BuyerTaxonomyPropertyValue $i): array => $i->toArray(), $this->possible_values);
        }
        if ($this->selected_values !== null) {
            $data['selected_values'] = array_map(static fn (BuyerTaxonomyPropertyValue $i): array => $i->toArray(), $this->selected_values);
        }
