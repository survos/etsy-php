 ...
 */
final readonly class SellerTaxonomyNode
{
    /**
     ...
     * @param list<SellerTaxonomyNode>|null $children An array of taxonomy nodes for all the direct children of this taxonomy node in the seller taxonomy tree.
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            children: isset($data['children']) && is_array($data['children'])
                ? array_values(array_map(static fn (array $i): SellerTaxonomyNode => SellerTaxonomyNode::fromArray($i), $data['children']))
                : null,
    ...
    public function toArray(): array
    {
        ...
        if ($this->children !== null) {
            $data['children'] = array_map(static fn (SellerTaxonomyNode $i): array => $i->toArray(), $this->children);
        }
