 ...
 */
final readonly class TransactionReview
{
    /**
     ...
     * @param int|null $transaction_id The ID of the ShopReceipt Transaction that the TransactionReview belongs to.
     * @param int|null $buyer_user_id The numeric ID of the user who was the buyer in this transaction. Note: This field may be absent, depending on the buyer's privacy settings.
